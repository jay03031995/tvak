  ...
  return (
    <div style={{ position: 'fixed', bottom: 24, left: 20, zIndex: 100, display: 'flex', flexDirection: 'column', gap: 10 }}>
      ...
      <a href="tel:09811997993" aria-label="Call"
        style={{ width: 48, height: 48, borderRadius: '50%', background: '#844d28', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 20px rgba(132,77,40,0.3)', transition: 'transform .2s' }}>
      ...
      {onBook && (
        <button onClick={onBook} aria-label="Book appointment"
          style={{ width: 48, height: 48, borderRadius: '50%', background: '#844d28', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 20px rgba(196,132,126,0.4)', transition: 'transform .2s', cursor: 'pointer' }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
