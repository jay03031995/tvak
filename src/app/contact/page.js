    ...
    <div style={{ background: 'var(--cream)' }}>
      <section style={{ padding: '52px 20px 44px', background: 'linear-gradient(180deg,#F5EDE4,#FAF7F2)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <h1 style={{ fontWeight: 500, marginBottom: 12 }}>Book a Consultation</h1>
          <p style={{ fontSize: 14, fontWeight: 300, color: '#7A6A5A', maxWidth: 480 }}>Fill the form below and we'll get back within a few hours, or call/WhatsApp us directly.</p>
        </div>
      </section>
      ...
      <section style={{ padding: '48px 20px 80px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }} className="grid-contact">
            ...
            <form style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
              ...
              <div>
                ...
                <select style={{ width: '100%', padding: '11px 14px', borderRadius: 10, border: '1.5px solid rgba(26,17,9,0.14)', fontSize: 13.5, fontWeight: 300, outline: 'none', background: '#FAF7F2', fontFamily: 'inherit', appearance: 'none' }}>
                  ...
                  {['Acne & Breakouts', 'Acne Scars', 'Pigmentation', 'Hair Fall', 'Anti-Ageing', 'Skin Glow', 'Other'].map(c => <option key={c} value={c}>{c}</option>)}
                </select>
              </div>
              <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {[
              { label: 'Phone', value: '098119 97993', link: 'tel:09811997993', icon: <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.63 3.49 2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.97a16 16 0 0 0 6.06 6.06l1.27-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/> },
              { label: 'WhatsApp', value: '+91 98119 97993', link: 'https://wa.me/919811997993', icon: <path d="M21 11.5a8.5 8.5 0 0 1-12.6 7.4L3 21l2.2-5.3A8.5 8.5 0 1 1 21 11.5Z"/> },
              { label: 'Address', value: 'Lotus Plaza, near Mithaas Sweets, Sector 104, Noida 201304', link: 'https://maps.app.goo.gl/jhaUTtPyvnzMNbKq5', icon: <><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></> },
            ].map((info, i) => (
              <div key={i} style={{ background: '#fff', borderRadius: 14, padding: '20px 20px', border: '1.5px solid rgba(26,17,9,0.09)', display: 'flex', gap: 14, alignItems: 'flex-start' }}>
            ...
            <div style={{ background: '#fff', borderRadius: 14, padding: '20px', border: '1.5px solid rgba(26,17,9,0.09)' }}>
              ...
              {[
                ...
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, fontWeight: 300, color: '#4A3728', paddingBottom: 8, borderBottom: i === 0 ? '1px solid rgba(26,17,9,0.07)' : 'none', marginBottom: 8 }}>
                  <span>{h.days}</span>
