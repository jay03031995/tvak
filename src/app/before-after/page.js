...
const STATIC_CASES = [
  { treatment: 'Acne Clearance Program', slug: 'acne-clearance', result: 'Active acne cleared across forehead and cheeks', weeks: '8 weeks', sessions: '6 sessions', cat: 'Acne & Scars', accent: '#FFF0EE', dot: '#844d28' },
  { treatment: 'Acne Scar Revision — MNRF', slug: 'microneedling', result: 'Pitted boxcar & rolling scars visibly reduced', weeks: '12 weeks', sessions: '4 sessions', cat: 'Acne & Scars', accent: '#f5e6d0', dot: '#b8894a' },
  { treatment: 'Melasma Treatment', slug: 'melasma', result: 'Dark patches on cheeks significantly faded', weeks: '10 weeks', sessions: '6 sessions', cat: 'Pigmentation', accent: '#f5e6d0', dot: '#b8894a' },
  { treatment: 'PRP Hair Restoration', slug: 'prp-hair', result: 'Visible density improvement and reduced fall', weeks: '16 weeks', sessions: '4 sessions', cat: 'Hair Restoration', accent: '#f5e6d0', dot: '#b8894a' },
  { treatment: 'Carbon Laser Facial', slug: 'carbon-laser-facial', result: 'Pores minimised, oil control improved', weeks: '6 weeks', sessions: '4 sessions', cat: 'Skin & Glow', accent: '#FFF0EE', dot: '#844d28' },
  { treatment: 'HydraFacial MD', slug: 'hydrafacial', result: 'Instant glow, deeply hydrated and plump skin', weeks: '1 session', sessions: '1 session', cat: 'Skin & Glow', accent: '#f5e6d0', dot: '#b8894a' },
  { treatment: 'Anti-Wrinkle Botox', slug: 'botox', result: "Forehead lines and crow's feet softened naturally", weeks: '2 weeks', sessions: '1 session', cat: 'Anti-Ageing', accent: '#EEF1F8', dot: '#844d28' },
  { treatment: 'GFC Hair Therapy', slug: 'gfc-hair', result: 'New hair growth visible in thinning crown', weeks: '12 weeks', sessions: '3 sessions', cat: 'Hair Restoration', accent: '#f5e6d0', dot: '#b8894a' },
]
  ...
  return (
    <div style={{ background: '#fff', borderRadius: 18, overflow: 'hidden', border: '1.5px solid rgba(26,17,9,0.08)' }}>
      <div style={{ position: 'relative', display: 'grid', gridTemplateColumns: '1fr 1fr', height: 220 }}>
        ...
        <div style={{ position: 'relative', background: '#C8BDB4' }}>
          <Image
            ...
            style={{ objectFit: 'cover' }}
          />
          <span style={{ position: 'absolute', bottom: 10, right: 10, fontSize: 10, fontWeight: 500, letterSpacing: '0.08em', textTransform: 'uppercase', background: 'rgba(132,77,40,0.85)', color: '#f5e6d0', padding: '4px 10px', borderRadius: 5 }}>After</span>
        </div>
      ...
      <div style={{ padding: '18px 20px 22px' }}>
        <div style={{ fontSize: 11, fontWeight: 500, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#b8894a', marginBottom: 8 }}>{treatmentCat}</div>
        ...
        {item.result && <p style={{ fontSize: 13, fontWeight: 300, color: '#7a6858', marginBottom: 14, lineHeight: 1.6 }}>{item.result}</p>}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
          <div style={{ display: 'flex', gap: 8 }}>
            {item.sessions && <span style={{ fontSize: 11.5, fontWeight: 400, color: 'rgba(72,63,55,0.55)', background: '#f5e6d0', padding: '4px 10px', borderRadius: 999 }}>{item.sessions}</span>}
          </div>
          <Link href={`/treatments/${treatmentSlug}`} style={{ fontSize: 12, fontWeight: 400, color: '#844d28', textDecoration: 'none' }}>View treatment →</Link>
        </div>
      </div>
    </div>
  )
...
function StaticCard({ item }) {
  const accentMap = { 'Acne & Scars': '#FFF0EE', Pigmentation: '#f5e6d0', 'Skin & Glow': '#f5e6d0', 'Hair Restoration': '#f5e6d0', 'Anti-Ageing': '#EEF1F8', 'Laser & Devices': '#F5F0FF' }
  const dotMap = { 'Acne & Scars': '#844d28', Pigmentation: '#b8894a', 'Skin & Glow': '#b8894a', 'Hair Restoration': '#b8894a', 'Anti-Ageing': '#844d28', 'Laser & Devices': '#7B5EA7' }
  const accent = item.accent || accentMap[item.cat] || '#f5e6d0'
  const dot = item.dot || dotMap[item.cat] || '#b8894a'
  return (
    <div style={{ background: '#fff', borderRadius: 18, overflow: 'hidden', border: '1.5px solid rgba(26,17,9,0.08)' }}>
      <div style={{ position: 'relative', display: 'grid', gridTemplateColumns: '1fr 1fr', height: 220 }}>
        ...
        <div style={{ background: '#C8BDB4', display: 'flex', alignItems: 'flex-end', padding: 12, justifyContent: 'flex-end' }}>
          <span style={{ fontSize: 10, fontWeight: 500, letterSpacing: '0.08em', textTransform: 'uppercase', background: 'rgba(132,77,40,0.85)', color: '#f5e6d0', padding: '4px 10px', borderRadius: 5 }}>After</span>
        </div>
        <div style={{ position: 'absolute', left: '50%', top: 0, bottom: 0, width: 2, background: '#fff', transform: 'translateX(-50%)' }}>
          <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 30, height: 30, borderRadius: '50%', background: '#fff', boxShadow: '0 2px 10px rgba(0,0,0,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#4A3728" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l-6-6 6-6M15 6l6 6-6 6"/></svg>
      ...
      <div style={{ padding: '18px 20px 22px' }}>
        ...
        <p style={{ fontSize: 13, fontWeight: 300, color: '#7a6858', marginBottom: 14, lineHeight: 1.6 }}>{item.result}</p>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
          <div style={{ display: 'flex', gap: 8 }}>
            <span style={{ fontSize: 11.5, fontWeight: 400, color: 'rgba(72,63,55,0.55)', background: '#f5e6d0', padding: '4px 10px', borderRadius: 999 }}>{item.weeks}</span>
            <span style={{ fontSize: 11.5, fontWeight: 400, color: 'rgba(72,63,55,0.55)', background: '#f5e6d0', padding: '4px 10px', borderRadius: 999 }}>{item.sessions}</span>
          </div>
          <Link href={`/treatments/${item.slug}`} style={{ fontSize: 12, fontWeight: 400, color: '#844d28', textDecoration: 'none' }}>View treatment →</Link>
        </div>
      </div>
    </div>
  )
...
export default async function BeforeAfterPage() {
  ...
  return (
    <div style={{ background: 'var(--cream)' }}>
      <section style={{ padding: '52px 20px 44px', background: 'linear-gradient(180deg,#f5e6d0,#f5e6d0)' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto' }}>
          <div style={{ fontSize: 12.5, color: 'rgba(72,63,55,0.55)', fontWeight: 300, marginBottom: 20, display: 'flex', gap: 6 }}>
            <Link href="/" style={{ color: 'rgba(72,63,55,0.55)', textDecoration: 'none' }}>Home</Link>
            <span>/</span>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            ...
            <Link href="/treatments" style={{ background: 'transparent', color: '#844d28', fontSize: 13, fontWeight: 400, padding: '12px 26px', borderRadius: 999, border: '1.5px solid rgba(132,77,40,0.2)', textDecoration: 'none' }}>View Treatments</Link>
          </div>
        </div>
      </section>

      <section style={{ background: '#844d28', padding: '20px' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto', display: 'flex', justifyContent: 'center', gap: 48, flexWrap: 'wrap' }}>
          {[{ value: '500+', label: 'Patients Treated' }, { value: '4.9★', label: 'Google Rating' }, { value: '100%', label: 'Doctor-Led Sessions' }, { value: '15+', label: 'Treatments Available' }].map((s, i) => (
            <div key={i} style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 20, fontWeight: 500, color: '#f5e6d0' }}>{s.value}</div>
              <div style={{ fontSize: 11.5, fontWeight: 300, color: '#b8894a', marginTop: 3 }}>{s.label}</div>
            </div>
          ))}
        </div>
      </section>
            ...
            <section key={cat} style={{ padding: '56px 20px', borderBottom: '1px solid rgba(26,17,9,0.07)' }}>
              <div style={{ maxWidth: 1180, margin: '0 auto' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 32, flexWrap: 'wrap', gap: 12 }}>
                  ...
                  <Link href="/concerns" style={{ fontSize: 13, fontWeight: 400, color: '#844d28', textDecoration: 'none' }}>Browse concerns →</Link>
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 22 }}>
      ...
      <section style={{ padding: '28px 20px', background: '#f5e6d0' }}>
        <p style={{ textAlign: 'center', fontSize: 12, fontWeight: 300, color: 'rgba(72,63,55,0.55)', maxWidth: 640, margin: '0 auto', lineHeight: 1.8 }}>
      ...
      <section style={{ padding: '64px 20px', background: '#1a1512' }}>
        <div style={{ maxWidth: 600, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontWeight: 500, color: '#f5e6d0', marginBottom: 10 }}>Ready to see your results?</h2>
          <p style={{ fontSize: 13.5, fontWeight: 300, color: '#c8b09a', marginBottom: 28 }}>
            Book a consultation with Dr. Omaima and get a personalised treatment plan with realistic expectations.
          </p>
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/contact" style={{ background: '#844d28', color: '#fff', fontSize: 13, fontWeight: 400, padding: '13px 32px', borderRadius: 999, textDecoration: 'none' }}>Book Appointment</Link>
